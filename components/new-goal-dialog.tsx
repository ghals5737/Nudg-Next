  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent showCloseButton={false} className="bg-[#EEF1F5] sm:max-w-2xl rounded-[3rem] shadow-[0px_12px_32px_rgba(31,41,55,0.06)] border-none p-0 gap-0 overflow-hidden max-h-[90vh] flex flex-col">
        <div className="px-8 pt-10 pb-6 bg-[#EEF1F5]/50">
          <div className="flex justify-between items-start mb-4">
            <div className="flex items-center gap-3 text-[#1F76EB]">
              ...
              <DialogTitle className="font-bold text-sm tracking-widest text-[#1F76EB] uppercase">새 목표</DialogTitle>
            </div>
          ...
          <div className="space-y-4">
            {steps.map((step, i) => (
              <div key={i} className="flex items-start gap-4 group">
                ...
                <div className="flex-1 bg-[#EEF1F5] rounded-[1.5rem] p-4 transition-all duration-300 group-hover:bg-[#EEF1F5]">
                  <input
                ...
                {steps.length > 1 && (
                  <button onClick={() => removeStep(i)} className="mt-2 text-[#6B7280]/40 hover:text-[#a83836] transition-colors p-2 opacity-0 group-hover:opacity-100">
        ...
        <div className="px-8 py-6 bg-white border-t border-[#EEF1F5]/50 flex justify-end gap-4">

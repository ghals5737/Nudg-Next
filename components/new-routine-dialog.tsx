    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="bg-[#EEF1F5] sm:max-w-2xl rounded-[2rem] shadow-[0px_12px_32px_rgba(31,41,55,0.06)] border-none p-0 gap-0 overflow-hidden">
        <div className="px-8 pt-10 pb-6 max-h-[90vh] overflow-y-auto">
          <div className="mb-12">
            <DialogTitle className="text-4xl md:text-5xl font-extrabold tracking-tight text-[#1F2937] mb-4">새 루틴</DialogTitle>
            <p className="text-lg text-[#6B7280] leading-relaxed">부드러운 리듬을 만들어 보세요.</p>
          </div>
